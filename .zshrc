...
plugins=(git zsh-history-substring-search fzf npm colored-man-pages zsh-syntax-highlighting zsh-autosuggestions)
...
alias doall='git add . && git commit -m "more" && git push'
alias cat='bat'

...
alias vim='nvim'
alias c='clear'
alias cursor='/tmp/.mount_cursorMJyy2J/cursor'
...
apachelog() {
	if [ -f /etc/httpd/conf/httpd.conf ]; then
		j /var/log/httpd && ls -xAh && multitail --no-repeat -c -s 2 /var/log/httpd/*_log
	else
		j /var/log/apache2 && ls -xAh && multitail --no-repeat -c -s 2 /var/log/apache2/*.log
	fi
}
